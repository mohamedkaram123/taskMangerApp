...
export default function CountrySelectData({name,error,options,value,menuPosition="",menue_direct="bottom",parent_class="",required=false,onChange,disabled=false,type,placeholder = name,id=type,col_md="6",col="12",classes=""}) {
...
const Option = (props) => {
    ...
    return(
      ...
      <div ref={innerRef} {...innerProps}  className='d-flex flex-row country-option w-100'>
        ...
        <span className='mx-2 country-label' >{props.data.label}</span>
